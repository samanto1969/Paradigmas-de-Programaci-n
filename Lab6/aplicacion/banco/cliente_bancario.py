...
class ClienteBancario:
    ...
    def __init__(self,nombres:str, apellidos:str, edad:int=0, balanceDeCuenta:float=0.0):
        self.__validaEdad(edad)
        self.__validaCantidad(balanceDeCuenta)
    ...
    def __mandaEmail(self, titulo:str, texto:str) -> None:
...
#======================================================================
    ...
    def __validaEdad(self, edad:int) -> None:
        if edad < 18:
    ...
    # y genera un error
    #===================================================================
    def __validaCantidad(self, balanceDeCuenta:float) -> None:
    ...
    def retirarDinero(self, cantidad:float) -> None:
        ...
        self.__validaCantidad(cantidadFinal)
